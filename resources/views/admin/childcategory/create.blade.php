            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 d-flex">
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ route('childcategory.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control @error('childcategory_name') is-invalid @enderror" name="childcategory_name" value="{{ old('childcategory_name') }}" autofocus />
