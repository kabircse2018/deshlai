    ...
    <div class="container">
        <div class="page-title">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page">আপনি দেখছেন: <a href="{{ url('/') }}">হোম </a> >> {{$subcategory->subcategory_slug}}</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="post-item border">
                <div class="post-item-wrap">
                    <div class="post-image">
                        <a href="{{ url('post/'. $category->category_slug. '/'. $item->post_slug) }}">
                    ...
                    <div class="post-item-description">
                        ...
                        <h2><a href="{{ url('post/'. $category->category_slug. '/'. $item->post_slug) }}">{{ Str::limit($item->post_title, 30) }} : {{$item->name}}</a></h2>
                        <span>
